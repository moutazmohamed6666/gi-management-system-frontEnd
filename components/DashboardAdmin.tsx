    ...
    <div className="space-y-6">
      ...
      <Card className="border-0 shadow-lg">
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="group relative overflow-hidden rounded-xl p-6 bg-linear-to-br from-blue-50 to-white border border-blue-100 hover:border-blue-200 hover:shadow-md transition-all duration-300">
            ...
            <div className="group relative overflow-hidden rounded-xl p-6 bg-linear-to-br from-green-50 to-white border border-green-100 hover:border-green-200 hover:shadow-md transition-all duration-300">
            ...
            <div className="group relative overflow-hidden rounded-xl p-6 bg-linear-to-br from-purple-50 to-white border border-purple-100 hover:border-purple-200 hover:shadow-md transition-all duration-300">
              ...
              <div className="relative">
                ...
                <div className="text-3xl text-purple-600 font-semibold">
                  {mockUsers.filter((u) => u.role === "ceo").length}
                </div>
              </div>
            </div>
            <div className="group relative overflow-hidden rounded-xl p-6 bg-linear-to-br from-orange-50 to-white border border-orange-100 hover:border-orange-200 hover:shadow-md transition-all duration-300">
      ...
      <Card className="border-0 shadow-lg">
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="group relative overflow-hidden rounded-xl p-4 bg-linear-to-br from-gray-50 to-white border border-gray-100 hover:border-gray-200 hover:shadow-md transition-all duration-300">
              <div className="absolute left-0 top-0 bottom-0 w-1 bg-blue-500"></div>
              <div className="flex items-center justify-between pl-3">
                <div>
                  <div className="text-gray-900 font-medium">
                    Deal D001 status updated
                  </div>
                  <div className="text-sm text-gray-600">
                    Emily Rodriguez • Finance Team
                  </div>
                </div>
            ...
            <div className="group relative overflow-hidden rounded-xl p-4 bg-linear-to-br from-gray-50 to-white border border-gray-100 hover:border-gray-200 hover:shadow-md transition-all duration-300">
              ...
              <div className="flex items-center justify-between pl-3">
                <div>
                  <div className="text-gray-900 font-medium">
                    Commission rule updated for Emaar
                  </div>
                  <div className="text-sm text-gray-600">
                    Admin User • Admin
                  </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="border-0 shadow-lg">
          ...
          <CardContent>
            <div className="space-y-3">
              <button className="w-full group relative overflow-hidden rounded-xl p-4 bg-linear-to-br from-blue-50 to-white border border-blue-100 hover:border-blue-300 hover:shadow-md transition-all duration-300 text-left">
              ...
              <button className="w-full group relative overflow-hidden rounded-xl p-4 bg-linear-to-br from-green-50 to-white border border-green-100 hover:border-green-300 hover:shadow-md transition-all duration-300 text-left">
              ...
              <button className="w-full group relative overflow-hidden rounded-xl p-4 bg-linear-to-br from-purple-50 to-white border border-purple-100 hover:border-purple-300 hover:shadow-md transition-all duration-300 text-left">
              ...
              <button className="w-full group relative overflow-hidden rounded-xl p-4 bg-linear-to-br from-orange-50 to-white border border-orange-100 hover:border-orange-300 hover:shadow-md transition-all duration-300 text-left">
